...
const RadioLoRaBandwidths_t Bandwidths[] = { LORA_BW_125, LORA_BW_250, LORA_BW_500,LORA_BW_062,LORA_BW_041,LORA_BW_031,LORA_BW_020,LORA_BW_015,LORA_BW_010,LORA_BW_007 };//{ LORA_BW_125, LORA_BW_250, LORA_BW_500 };
                              ...
                              bool iqInverted, bool rxContinuous )
{
    ...
    switch( modem )
    {
        ...
        case MODEM_LORA:
            ...
            //if( ( ( bandwidth == 0 ) && ( ( datarate == 11 ) || ( datarate == 12 ) ) ) ||//weli mark
            //    ( ( bandwidth == 1 ) && ( datarate == 12 ) ) )
            //weli add 20230209 for enable low datarate optimize
            if( ( ( bandwidth == 0 ) && ( ( datarate == 11 ) || ( datarate == 12 ) ) ) ||
                ( ( bandwidth == 1 ) && ( datarate == 12 ) ) ||
                ( ( bandwidth == 3 ) && ( ( datarate >= 10 ) || ( datarate <= 12 ) ) ) ||
                ( ( bandwidth == 4 ) && ( ( datarate >= 10 ) || ( datarate <= 12 ) ) ) ||
                ( ( bandwidth == 5 ) && ( ( datarate >= 9 ) || ( datarate <= 12 ) ) ) ||
                ( ( bandwidth == 6 ) && ( ( datarate >= 9 ) || ( datarate <= 12 ) ) ) ||
                ( ( bandwidth == 7 ) && ( ( datarate >= 8 ) || ( datarate <= 12 ) ) ) ||
                ( ( bandwidth == 8 ) && ( ( datarate >= 8 ) || ( datarate <= 12 ) ) ) ||
                ( ( bandwidth == 9 ) && ( ( datarate >= 7 ) || ( datarate <= 12 ) ) )
                )
            //if(1)//weli add
            {
