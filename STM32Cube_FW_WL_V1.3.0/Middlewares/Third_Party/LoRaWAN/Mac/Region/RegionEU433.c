...
bool RegionEU433TxConfig( TxConfigParams_t* txConfig, int8_t* txPower, TimerTime_t* txTimeOnAir )
{
    ...
    {
        modem = MODEM_LORA;
        Radio.SetTxConfig( modem, phyTxPower, 0, bandwidth, phyDr, 1, 8, false, true, 0, 0, false, 4000 );//weli mark original
		        Radio.SetTxConfig( modem, 22, 0, bandwidth, phyDr, 1, 8, false, true, 0, 0, false, 4000 );//weli add,fixed tx power is 22 dBm.
    }
